export const environment = {
  production: true,
  version: '1.0.2', // aggiorna qui quando fai il deploy di produzione
  // Imposta l'URL pubblico definitivo dell'app. Es: "https://tuo-utente.github.io/sviluppo" o il tuo dominio di produzione.
  publicBaseUrl: '',
  firebase: {
